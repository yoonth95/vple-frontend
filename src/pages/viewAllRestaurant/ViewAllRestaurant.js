...
function ViewAllRestaurant() {
    ...
    const fetchData = async () => {
        ...
        console.log(document.getElementById('selected_city').value !== selectedCity);
        console.log(document.getElementById('selected_province').value !== selectedProvince);
        ...
        else if (document.getElementById('selected_province').value !== selectedProvince) {
